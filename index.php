...
<body>
	...
	<header class="header">
		...
		<a class="header__block nav-block" id="post-job-icon" href="#">
		...
		<div class="header__img-3-4">
			...
			<a class="header__block nav-block" id="profile-icon" href="#">
		...
		<a class="header__block nav-block header__img-5" href="#">
		...
		<nav class="header__burger-menu">
			<a class="nav-block" id="post-job-icon2" href="#">
			...
			<a class="nav-block" id="profile-icon2" href="#">
	...
	<!--  -->
	<!-- !!! PROFILE -->
	<section hidden class="two-cards-bg" id="profile">
		...
		<!-- ! EMPLOYER -->
		<!--  -->
		<div class="two-cards-flex two-cards-flex__employer">
			<!-- ! CARD PROFILE -->
			<div class="card card__post-job">
				<div class="profile-employer-card">
					<label class="profile-employer-card__label" for="employer-radio1">
						<span class="profile-employer-card__job-number">Job Post #1</span>
						<input class="profile-employer-card__radio" type="radio" name="employer-radio" id="employer-radio1">
					</label>

					<label class="profile-employer-card__label" for="employer-radio2">
						<span class="profile-employer-card__job-number">Job Post #2</span>
						<input class="profile-employer-card__radio" type="radio" name="employer-radio" id="employer-radio2">
					</label>

					<label class="profile-employer-card__label" for="employer-radio3">
						<span class="profile-employer-card__job-number">Job Post #3</span>
						<input class="profile-employer-card__radio" type="radio" name="employer-radio" id="employer-radio3">
					</label>

					<label class="profile-employer-card__label" for="employer-radio4">
						<span class="profile-employer-card__job-number">Job Post #4</span>
						<input class="profile-employer-card__radio" type="radio" name="employer-radio" id="employer-radio4">
					</label>

					<label class="profile-employer-card__label" for="employer-radio5">
						<span class="profile-employer-card__job-number">Job Post #5</span>
						<input class="profile-employer-card__radio" type="radio" name="employer-radio" id="employer-radio5">
					</label>

					<label class="profile-employer-card__label" for="employer-radio6">
						<span class="profile-employer-card__job-number">Job Post #6</span>
						<input class="profile-employer-card__radio" type="radio" name="employer-radio" id="employer-radio6">
					</label>

					<label class="profile-employer-card__label" for="employer-radio7">
						<span class="profile-employer-card__job-number">Job Post #7</span>
						<input class="profile-employer-card__radio" type="radio" name="employer-radio" id="employer-radio7">
					</label>
			...
			<!-- ? CARD PROFILE -->
			<img class="two-cards-flex__arrow" src="img/icons/arrow.svg" alt="arrow">
			<!-- ! CARD PROFILE EXAMPLE -->
			<div class="card card__post-job-example">
				<img class="card__logo" src="img/bitten-donut.jpg" alt="card__post-job-EXAMPLE-logo">
				<div class="card__job-title card__post-job-example-title">Job title duis ad fugiat do do adipisic</div>
				<div class="card__company-name card__post-job-example-company-name">Company name id do deserunt officia
					qui
					velit non
					pariatur ut.</div>
				<!--  -->
				...
				<!--  -->
				<div class="card__icons card-icons card__post-job-example-icons_employer">
