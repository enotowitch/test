		...
		<div class="card card__post-job">
			<form class="post-job-form" id="post-job-form" action="insert.php" method="post" enctype="multipart/form-data">
				...
				<ul class="card__post-job-options">
					...
					<input type="file" class="card-option__example card-option__post-job-example" id="card-option__post-job-example">
					<!-- РАЗНЫЕ КАРТЫ ДОБАВЛЯЙ ЧЕРЕЗ ИНКЛУД + flex сделай! -->
				</ul>
				<!--  -->
