		...
		<div class="card card__post-job">
			<form class="post-job-form" action="#" method="post" enctype="multipart/form-data">
				...
				<div class="card__tags">
					...
					<select class="post-job-tags-select" title="Choose 3 tags" data-placeholder="Choose 3 tags..." multiple>
				...
				<!--  -->
				<input class="card__icons card-icons card__post-job-icons post-job-reset" type="reset" id="aplicant-reset">
